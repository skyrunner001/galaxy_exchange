...
@WebFault
public class ExchangeWebServiceRuntimeException extends RuntimeException {
	 ...
	 * 
	 */
	public ExchangeWebServiceRuntimeException() {
		super();
	}
	 ...
	 * @param varargs
	 */
	public ExchangeWebServiceRuntimeException(String key, Object... varargs) {
	 ...
	 * @param varargs
	 */
	public ExchangeWebServiceRuntimeException(Throwable cause, String key, Object... varargs) {
	 ...
	 * @param cause
	 */
	public ExchangeWebServiceRuntimeException(Throwable cause) {
		super(cause);
	}
